...
export function orderAccountsForRotate(accounts, lastPickedId) {
...
export function classifyFlowFailure(message) {
  ...
  if (/flow ui changed/i.test(msg)) return "ui";
  if (/session expired|sign in|not logged|login required|reconnect/i.test(msg)) return "expired";
  return "other";
}
